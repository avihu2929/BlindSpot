...
public class DetectorFactory {
    public static YoloV5Classifier getDetector(
        ...
        else if (modelFilename.equals("scooter.tflite")) {
            labelFilename = "file:///android_asset/scooter.txt";
            isQuantized = false;
            inputSize = 640;
            output_width = new int[]{40, 20, 10};
            masks = new int[][]{{0, 1, 2}, {3, 4, 5}, {6, 7, 8}};
        ...
        return YoloV5Classifier.create(context,assetManager, modelFilename, labelFilename, isQuantized,
                inputSize);
    }
